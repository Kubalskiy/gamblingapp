...
return [
    ...
    'Bet:' => 'Ставка:',
    'Profile' => 'Мой Профайл',
    'Get invite' => 'Получить инвайт',
    'My Company' => 'Лохотрон V.1.0',
    ...
    'Hello friend!' => 'Ну, здравствуй, не ЛОХ!',
    'Random game' => 'Random game',
    'I am lucky, Bet money' => 'Мне везет! Играть на бабки.',
    'Logout {username}' => 'Бежать отсюда ({username})!',
    'Wait for opponent' => 'Ждем ставки от ЛОХа',
